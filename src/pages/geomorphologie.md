...
description: Landformen, endogene und exogene Prozesse, Naturgefahren
---
...
<!-- Bild-Quelle: https://commons.wikimedia.org/wiki/File:Earth_elevation_map.png -->
![Globales Höhenmodell der Erde](earth_elevation_map.png)
*Höhenrelief der Erde – Quelle: NASA/USGS, Wikimedia Commons (Public Domain)*

## Forschungsgegenstände der Geomorphologie

Die Geomorphologie untersucht:

1. **Oberflächenformen** – Beschreibung und Klassifikation von Landformen
2. **Prozesse** – Mechanismen der Landformung (aktuell und historisch)
3. **Materialien** – Gesteine und Sedimente
4. **Zeitliche Entwicklung** – Landschaftsgenese über geologische Zeiträume
5. **Räumliche Verbreitung** – Regionale Muster von Landformen
6. **Mensch-Umwelt-Interaktionen** – Anthropogene Geomorphologie
...
<!-- Bild-Quelle: https://commons.wikimedia.org/wiki/File:Plates_tect2_en.svg -->
![Plattentektonik weltweit](plates_tect2_en.svg)
*Tektonische Platten und ihre Bewegungen – Quelle: USGS, Wikimedia Commons (Public Domain)*

**Endogene Prozesse umfassen:**

1. **Epirogenese** – Großräumige Hebungen und Senkungen von Krustenteilen
2. **Orogenese** – Gebirgsbildung durch Plattenkollision
3. **Kontinentaldrift** – Öffnung und Schließung von Ozeanen
4. **Erdbeben** – Seismische Aktivität an Plattengrenzen
5. **Vulkanismus** – Magmatische Aktivität (Plutonismus und Vulkanismus)
...
Abhängig von Klima (Temperatur, Feuchtigkeit), Gestein, Relief
...
<!-- Bild-Quelle: https://commons.wikimedia.org/wiki/File:Mass_wasting_types.svg -->
![Typen von Massenbewegungen](mass_wasting_types.svg)
*Klassifikation von Massenbewegungen – Quelle: Wikimedia Commons (CC BY-SA)*
...
- [NASA Landslide Portal](https://landslides.nasa.gov/)
...
<!-- Bild-Quelle: https://commons.wikimedia.org/wiki/File:Grand_Canyon_view_from_Pima_Point_2010.jpg -->
![Grand Canyon](grand_canyon_view_from_pima_point_2010.jpg)
*Grand Canyon – Meisterwerk fluvialer Erosion – Quelle: Wikimedia Commons (Public Domain)*
...
<!-- Bild-Quelle: https://commons.wikimedia.org/wiki/File:Aletsch_Glacier.jpg -->
![Aletschgletscher](aletsch_glacier.jpg)
*Aletschgletscher, Schweiz – größter Gletscher der Alpen – Quelle: Wikimedia Commons (CC BY-SA)*
...
**Glaziale Serie (nach Penck):**
Typische Abfolge von Formen am Gletscherrand:
1. Grundmoräne (Geschiebemergel)
2. Endmoräne (Stauchwall)
3. Sander (Schmelzwasserebene)
4. Urstromtal
...
<!-- Bild-Quelle: https://commons.wikimedia.org/wiki/File:Permafrost_distribution.png -->
![Permafrost-Verbreitung](permafrost_distribution.png)
*Permafrost-Verbreitung auf der Nordhalbkugel – Quelle: Wikimedia Commons (Public Domain)*
...
- [GTN-P – Global Terrestrial Network for Permafrost](https://gtnp.arcticportal.org/)
...
<!-- Bild-Quelle: https://commons.wikimedia.org/wiki/File:Erg_Chebbi_Dunes.jpg -->
![Sahara-Dünen](erg_chebbi_dunes.jpg)
*Dünenfeld in der Sahara (Marokko) – Quelle: Wikimedia Commons (CC BY-SA)*
...
<!-- Bild-Quelle: https://commons.wikimedia.org/wiki/File:Cliffs_of_Moher_sunset.jpg -->
![Cliffs of Moher](cliffs_of_moher_sunset.jpg)
*Steilküste Cliffs of Moher, Irland – Quelle: Wikimedia Commons (CC BY-SA)*
...
**Aktuelle Forschung:**
- IPCC (2019): *Special Report on the Ocean and Cryosphere*. [Link](https://www.ipcc.ch/srocc/)
...
<!-- Bild-Quelle: https://commons.wikimedia.org/wiki/File:Shilin_Stone_Forest_Karst.jpg -->
![Shilin Steinwald China](shilin_stone_forest_karst.jpg)
*Steinwald (Shilin), China – tropischer Kegelkarst – Quelle: Wikimedia Commons (CC BY-SA)*
...
- [International Association of Hydrogeologists – Karst Commission](https://iah.org/groups/karst)
...
- [Bundeszentrale für politische Bildung – Naturgefahren](https://www.bpb.de/)
- [Planet Schule – Geomorphologie](https://www.planet-schule.de/)
- [USGS Education](https://www.usgs.gov/education)
...
**Visualisierungen:**
- [Google Earth](https://earth.google.com/) – 3D-Geländemodelle
- [NASA Worldview](https://worldview.earthdata.nasa.gov/) – Satellitendaten
...
**Zeitschriften:**
- *Geomorphology* – [journals.elsevier.com/geomorphology](https://www.journals.elsevier.com/geomorphology)
